...
```
### :heavy_check_mark: Run the continaerized Mock TI API Endpoint solution <br/>
...
```
### :heavy_check_mark: Query SC X-GEN TI API Endpoint (w/ auth) <br/>
...
:heavy_exclamation_mark: Be sure to <span style="color:red; font-weight:bold;">RENAME</span> .env.example :arrow_right: .env before deployment!
...
## :star: MOCK TI REST API ENDPOINT
